...
const AccordionItem: React.FC<FAQItem & { isOpen: boolean; toggle: () => void }> = ({
  question,
  answer,
  isOpen,
  toggle
  ...
  const faqs: FAQItem[] = [
    {
      ...
      answer: 'The app continues to function without internet connection. Your changes are saved locally and automatically sync when connection is restored.'
    },
    {
      id: 'status',
      question: 'How do I change my work status?',
      answer: 'Select any day from the calendar and use the status buttons (Full Day, Half Day, Off) to update your status. Changes are saved automatically.'
    },
    {
      id: 'sync',
      question: 'Why are my changes not syncing?',
      answer: 'Changes may take a few minutes to sync. Check your internet connection and the sync status in the Data Management section.'
    }
  ];
